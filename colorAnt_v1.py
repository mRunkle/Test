...
class myframe(wx.Frame):
    def __init__(self):
		...
		self.textRGB=wx.Panel(self, size=(60, 60))
		self.textRGB.SetBackgroundColour("grey")
		self.myGridSizer.Add(self.textRGB, pos=(6, 0))#, span=(4,4), flag=wx.ALL)
		
		#text application
		self.text1 = wx.StaticText(self.textRGB, label="RGB", style=2, size=(350, -1))
		...
		'''
		#RGB value ground panel
		self.valueRGB=wx.Panel(self, size=(246, 60))
		self.valueRGB.SetBackgroundColour("grey")
		self.myGridSizer.Add(self.valueRGB, pos=(6, 1), span=(1,4))#, flag=wx.ALL)
		
		#text application
		self.text1 = wx.StaticText(self.valueRGB, label="255, 255, 255", style=2, size=(350, -1))
		font = wx.Font(18, wx.DECORATIVE, wx.ITALIC, wx.BOLD, wx.NORMAL)
		self.text1.SetFont(font)

		self.titleSizer = wx.BoxSizer()
		self.titleSizer.Add(self.text1, flag=wx.CENTER|wx.CENTER|wx.ALIGN_RIGHT, border=10)
		self.textRGB.SetSizer(self.titleSizer)
